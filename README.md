...
- [CMakeLists.txt Composition](cmakeliststxt-composition)
- [CMake Commands](cmake-commands)
  - [add_executable()](add_executableexec_name-source_files)
  - [project()](projectproject_name-version-project_version)
  - [cmake_minimum_required()](cmake_minimum_requiredversion-cmake_version)
  - [add_library()](add_librarylibrary_name-source_files)
  - [target_link_libraries()](target_link_librariesexecutable-lib1-lib2)
  - [message()](messagemode_of_display-the-message)
  - [set()](setvariable_name-variable_value)
  - [list()](listsubcommand-name_of_list----return_variable)
  - [string()](string)
  - [file()](file)
...
- [Targets](targets)
- [Propagating Target Properties](propagating-target-properties)
- [Target Prefix/Suffix](target-prefixsuffix)
- [Library Folder Structure](library-folder-structure)
